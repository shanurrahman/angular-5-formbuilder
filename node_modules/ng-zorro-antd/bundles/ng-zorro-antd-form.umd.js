...
}(this, (function (exports, layout, platform, common, core, outlet, grid, icon, forms, animation, util, i18n, rxjs, operators, config) { 'use strict';
    ...
    var NzFormControlComponent = /** @class */ (function () {
        ...
        NzFormControlComponent.prototype.validateControlStatus = function (validStatus, statusType) {
            if (!this.validateControl) {
                ...
                var _j = this.validateControl, dirty = _j.dirty, touched = _j.touched, status = _j.status;
